...
const Contact = () => {
    ...
    return (
        <section className="bg-bg-supporting py-24 px-6 md:px-20 lg:px-24" id="contact">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-16 items-start">
                            ...
                            {[
                                ...
                                link.title !== "LinkedIn Profile" ?
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div className="font-semibold text-sm text-primary mb-0.5">{link.title}</div>
                    ...
                    <div className="bg-white border border-border-subtle rounded-[20px] p-8 md:p-12 fade-in" ref={formRef}>
                        <h3 className="font-dm-sans text-[26px] font-bold text-primary mb-2">Send a Message</h3>
                        ...
                        <form className="flex flex-col gap-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors" placeholder="Enter first name" />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label className="text-[13px] font-bold text-primary">Last Name *</label>
                                    <input className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors" placeholder="Enter last name" />
                                </div>
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-[13px] font-bold text-primary">Email *</label>
                                <input className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors" placeholder="example@domain.com" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-[13px] font-bold text-primary">Organisation</label>
                                <input className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors" placeholder="Company or institution" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-[13px] font-bold text-primary">Subject *</label>
                                <select className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors appearance-none cursor-pointer">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea className="w-full bg-white border border-border-subtle rounded-lg py-3 px-4 text-sm focus:border-accent outline-none transition-colors min-h-[140px] resize-y" placeholder="Type your message here..."></textarea>
                            </div>
