...
const Merchandise = () => {
  ...
  return (
    <section className="bg-navy py-24 px-6 md:px-20 lg:px-24 relative overflow-hidden" id="merch">
      {/* Decorative gradient */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-14 fade-in" ref={headerRef}>
          <span className="section-label text-gold">The HI Collection</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12 fade-in" ref={gridRef}>
          {MERCHANDISE.map((item, i) => (
            <div key={i} className="bg-white/5 border border-white/10 rounded-[18px] overflow-hidden group hover:border-gold transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-5">
                ...
                <div className="font-playfair text-xl font-bold text-gold mb-3">{item.price}</div>
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-14 fade-in" ref={bundlesRef}>
          <div className="bg-white/5 border border-white/10 rounded-[18px] p-1 flex items-center gap-1 hover:border-gold transition-all group">
            ...
            <div className="p-4 flex-1">
              ...
              <div className="flex justify-between items-center">
                <div className="font-playfair text-lg font-bold text-gold">$299 <span className="font-dm-sans text-xs text-white/35 font-normal">/ year</span></div>
                <button className="text-xs font-bold text-white hover:text-gold transition-colors">Subscribe →</button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-[18px] p-1 flex items-center gap-1 hover:border-gold transition-all group">
            ...
            <div className="p-4 flex-1">
              ...
              <div className="flex justify-between items-center">
                <div className="font-playfair text-lg font-bold text-gold">$149</div>
                <button className="text-xs font-bold text-white hover:text-gold transition-colors">Buy Now →</button>
              </div>
            </div>
          </div>
        </div> */}
        ...
        <div className="text-center text-[13px] text-white/30 fade-in" ref={footerRef}>
          🚚 Free shipping on orders over <span className="text-gold">$100</span> · Worldwide delivery · Digital downloads available instantly
        </div>
      </div>
    </section>
  );
